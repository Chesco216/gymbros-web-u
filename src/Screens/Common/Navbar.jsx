...
export const Navbar = ({ dropDownMenuList }) => {
		...
		<header className="flex bg-primary px-3 py-5 shadow-md w-full sm:px-4 sm:py-5 xl:px-32 xl:py-6 items-center justify-center">
			...
			>
				<button
					...
					className="text-black bg-white hover:bg-gray-300/90 focus:ring-4 focus:outline-none focus:ring-primary font-bold rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center gap-1 xl:gap-2 xl:px-10 xl:py-5 border border-gray-200"
					type="button"
				>
