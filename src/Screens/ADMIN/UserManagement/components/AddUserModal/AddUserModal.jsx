				...
				<div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
					<div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
						<div className="bg-white px-4 pb-5 pt-6 sm:p-7 sm:pb-6">
							...
							<p className="slide-in text-md text-gray-500 my-3 ">Estas a punto de <strong className="underline">{mod}</strong> un usuario. Ingresa los campos correspondientes para dicha accion.</p>
							...
							<form id='myform' onSubmit={() => handleAddUser()} className="flex flex-col justify-center px-auto gap-1">
								...
								<input
									...
									required
								/>
								<label className="slide-in text-md text-gray-900">Plan de entrenamiento:</label>
								<input
									type='text'
									name='plan'
									value={plan}
						...
						<div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 gap-2">
							<button data-modal-hide="cu-users" type="button" className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-md font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto fade-in" onClick={handleCancelModal}>Cancelar</button>
							<button form="myform" value={"Submit"} type="submit" className="inline-flex w-full justify-center rounded-md bg-primary px-3 py-2 text-md font-semibold text-white shadow-sm hover:bg-primary/90 sm:ml-3 sm:w-auto fade-in" >{mod} usuario</button>
						</div>
					</div>
				</div>
			</div>
