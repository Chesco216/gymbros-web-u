			...
			<button type="submit" className="flex flex-row gap-3 justify-center items-center bg-primary py-4 border-black border font-semibold hover:bg-primary/90 shadow-md fade-in">
				{
					(loadingBtn) &&
					<>
						<svg aria-hidden="true" width='35px' height='35px' className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
