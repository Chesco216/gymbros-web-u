...
export const GymHeader = ({ id, name, stars, number_of_reviews, extra_services, image_url, text_address, suscription_price }) => {
	...
	return (
		<section className='flex flex-col gap-3 w-full'>
			<img src={image_url} alt="" className="w-full h-[200px] md:h-[400px] xl:h-[500px] object-cover xl:blur-[6px] lg:blur-[3px] shadow-lg xl:shadow-2xl" />

			<div className="flex flex-col gap-3 px-4 xl:px-8 py-2 xl:py-4 xl:gap-4">
				<div className='flex flex-col'>
					<h1 className='text-3xl uppercase font-extrabold sm:text-4xl xl:text-5xl'>{name}</h1>
					<p className='flex items-center text-lg font-md sm:text-xl xl:text-2xl'> <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>{text_address}</p>
				</div>
